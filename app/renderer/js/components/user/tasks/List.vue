<template>
  <div ref="taskList" class="tasks">
    <div v-if="notSyncedAmount > 0" class="not-synced-intervals">
      {{ $t("Not synced intervals") }}:
      <span class="not-synced-intervals__amount">{{ notSyncedAmount }}</span>
    </div>
