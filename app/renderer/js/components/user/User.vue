<template>
  <div class="app-container">
    <el-header class="app-controls glass elevated">
    ...
    <transition name="fade">
      ...
      >
        ...
        <div class="el-alert__content">
          ...
          <p class="el-alert__description">Waiting for reconnection</p>
        </div>
      </div>
    </transition>
...
export default {
  ...
  watch: {
    ...
    activityTimeLeft() {
      if (this.activityTimeLeft < 1) clearInterval(this.activity.interval);
    },
  },
  ...
  async mounted() {
    ...
    (async () => {
      const offlineStatus = await this.$ipc.request(
...
.app-container {
  ...
  .view {
    ...
    background: radial-gradient(#3797c6 1.5px, transparent 1.5px);
